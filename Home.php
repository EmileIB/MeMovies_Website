...
<body>
    ...
    <div class="container-fluid">
        <div id="OurTopMoviesSlider" class="carousel slide">
            <div class="carousel-inner">
                <?php 
                    $sql = "SELECT MovieName, Poster, ReleaseYear, Length, Trailer 
                    FROM movie as M, ourtoppicks as our
                    WHERE M.MovieID = our.MovieID
                    ORDER BY RAND();";
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        if ($i == 0){
                            ...
                            echo '<div class="movie-container no-margin">';
                        }
                        else if ($i % 5 == 0){
                        ...
                        echo '<a href="'.$row['Trailer'].'"target="_blank">';
                        echo '<img src="'.$row['Poster'].'"></a>';
                        echo '</div>';
                        echo '<div class="movie-info">';
                        echo '<p>'.$row['MovieName'].'</p>';
                        echo '<p class="yl">' .$row['ReleaseYear'].' | ' .$row['Length']. ' min</p>';  
                        echo '</div>';
                        echo '</div>';
                        if ($i % 5 == 4){
                            echo '</div>'; 
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#OurTopMoviesSlider" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#OurTopMoviesSlider" data-bs-slide="next">
    ...
    <div class="container-fluid">
        <div id="ActionMoviesSlider" class="carousel slide">
            <div class="carousel-inner">
                <?php 
                    $sql = "select MovieName, Poster, ReleaseYear, Length, Trailer
                    from movie as M, genre as G
                    where M.MovieID = G.MovieID and G.MovieGenre = 'Action'
                    ORDER BY RAND()
                    LIMIT 15;";
                    $result = mysqli_query($conn, $sql);
                    $resultCheck = mysqli_num_rows($result);
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#ActionMoviesSlider" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#ActionMoviesSlider" data-bs-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Next</span>
            </button>
          </div>
    ...
    <div class="container-fluid">
        <div id="DramaMoviesSlider" class="carousel slide">
            <div class="carousel-inner">
                <?php 
                    $sql = "select MovieName, Poster, ReleaseYear, Length, Trailer
                    from movie as M, genre as G
                    where M.MovieID = G.MovieID and G.MovieGenre = 'Drama'
                    ORDER BY RAND()
                    LIMIT 15;;";
                    $result = mysqli_query($conn, $sql);
                    $resultCheck = mysqli_num_rows($result);
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#DramaMoviesSlider" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#DramaMoviesSlider" data-bs-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Next</span>
            </button>
          </div>
    ...
    <div class="container-fluid">
        <div id="ComedyMoviesSlider" class="carousel slide">
            <div class="carousel-inner">
                <?php 
                    $sql = "select MovieName, Poster, ReleaseYear, Length, Trailer
                    from movie as M, genre as G
                    where M.MovieID = G.MovieID and G.MovieGenre = 'Comedy'
                    ORDER BY RAND()
                    LIMIT 15;";
                    $result = mysqli_query($conn, $sql);
                    $resultCheck = mysqli_num_rows($result);
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#ComedyMoviesSlider" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#ComedyMoviesSlider" data-bs-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Next</span>
            </button>
          </div>
    ...
    <div class="container-fluid">
        <div id="HorrorMoviesSlider" class="carousel slide">
            <div class="carousel-inner">
                <?php 
                    $sql = "select MovieName, Poster, ReleaseYear, Length, Trailer
                    from movie as M, genre as G
                    where M.MovieID = G.MovieID and G.MovieGenre = 'Horror'
                    ORDER BY RAND()
                    LIMIT 15;";
                    $result = mysqli_query($conn, $sql);
                    $resultCheck = mysqli_num_rows($result);
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#HorrorMoviesSlider" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#HorrorMoviesSlider" data-bs-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Next</span>
            </button>
          </div>
